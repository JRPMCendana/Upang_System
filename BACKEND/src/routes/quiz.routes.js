...
// Teacher routes - create, update, delete quizzes
router.post('/', authMiddleware, authorize('teacher'), upload.single('document'), QuizController.createQuiz);

router.get('/', authMiddleware, authorize('teacher', 'student'), QuizController.getQuizzes);

router.get('/:quizId', authMiddleware, authorize('teacher', 'student'), QuizController.getQuizById);

router.put('/:quizId', authMiddleware, authorize('teacher'), upload.single('document'), QuizController.updateQuiz);

router.delete('/:quizId', authMiddleware, authorize('teacher'), QuizController.deleteQuiz);
...
// Teacher routes - view all submissions for a quiz, grade submissions
router.get('/:quizId/submissions', authMiddleware, authorize('teacher'), QuizSubmissionController.getSubmissionsByQuiz);

router.put('/submissions/:submissionId/grade', authMiddleware, authorize('teacher'), QuizSubmissionController.gradeSubmission);
