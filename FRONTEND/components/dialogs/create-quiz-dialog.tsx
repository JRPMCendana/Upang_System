...
import type { CreateQuizData } from "@/types/quiz.types"
...
interface CreateQuizDialogProps {
  ...
  onSubmit: (data: CreateQuizData & { studentIds: string[] }, file?: File) => Promise<void>
  loading?: boolean
}

export function CreateQuizDialog({ open, onOpenChange, onSubmit, loading }: CreateQuizDialogProps) {
  const [formData, setFormData] = useState<CreateQuizData & { studentIds: string[] }>({
    title: "",
    description: "",
    quizLink: "",
    dueDate: "",
